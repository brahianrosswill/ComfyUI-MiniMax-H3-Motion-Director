...
.mmx-director-page-shell{width:92vw;height:90vh;max-width:calc(100vw - 24px);max-height:calc(100vh - 24px);min-width:0;min-height:0;display:flex;flex-direction:column;overflow:hidden;border:1px solid #3a3a3a;border-radius:9px;background:#141414;box-shadow:0 20px 70px rgba(0,0,0,.72);color:#e0e0e0;font-family:ui-sans-serif,system-ui,-apple-system,sans-serif}
