...
const EXPECTED = {
    zh: {
        ...
        "widget.tooltip.audioContextEnabled": "延续上一段的模型生成音频。仅生成音频模式生效。",
    ...
    en: {
        ...
        "widget.tooltip.audioContextEnabled": "Continue model-generated audio from the previous segment. Available only in generated-audio mode.",
